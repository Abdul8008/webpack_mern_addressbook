    ...
    return (
        <Formik
            ...
            onSubmit={(values, { resetForm }) => {
                ...
                api.authenticate.login(formBody)
                .then(res => {
                    if(res.status == 200){
                ...
                return (
                    <div>
                        ...
                        <div className="card mx-auto" style={{ width: '60%', margin: '20px auto', padding: '20px' }}>
                            <h2 style={{ fontFamily: `Grand Hotel, cursive` }} className="center">SIGN IN</h2>
                            ...
                            <div className="row mx-auto col-sm-12" style={{ border: '', width: '80%' }}>
                                <Form className="col-sm-12 col-md-12" onSubmit={handleSubmit}>
                                    ...
                                    <ButtonContained buttonName="Sign In"
                                        // disabled={isSubmitting} 
                                        />
                            ...
                            <Link to="/signup" className="center" style={{ display: 'block', color: '#FF3F6C' }}>New user ? Please signUp</Link> <br />
                            <Link to="/forgot" className="center" style={{ display: 'block', color: '#FF3F6C' }}>Forgot Password ?</Link>
